...
/**
 * Displays client information in a modal.
 * @param url - The URL to fetch client data from.
 * @param anchor - The anchor element that triggered the action.
 * @returns {Promise<void>}
 */
export async function showClient(url, anchor) {
	// Show loading state
	...
	try {
		...
		// Display client information in a modal
		if (html) {
			SwalModal.fire({
