...
import { calculateAlertDate, generateEan13, roundToNearestFive, setLoadingState } from "../../utils/utils.js";
import { openCategoryModal } from "../category/offcanvas/category.js";
...
export function syncProductUI() {
	...
	if (isMerchandise) {
		...
		$salePriceHidden.val(roundToNearestFive(finalPrice));
		$salePrice.val(roundToNearestFive(finalPrice));
