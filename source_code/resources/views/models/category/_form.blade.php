<div class="container p-0">
    ...
    <div class="table-container rounded-2 p-4 w-75 justify-content-start">
        <form
            id="{{ isset($category) ? 'edit-category-form' : 'create-category-form' }}"
        ...
        >
            ...
            <div class="d-flex justify-content-end gap-2">
                ...
                {{-- Submit Button --}}
                <x-form.submit
                    :id="isset($category) ? 'edit-category-form-button' : 'create-category-form-button'"
                    :spinnerId="isset($category) ? 'edit-category-form-spinner' : 'create-category-form-spinner'"
                    :class="'btn-primary px-4'"
                    :loadingMessage="isset($category) ? 'Actualizando...' : 'Guardando...'"
                >
                    <div
                        id="{{ isset($category) ? 'edit-category-form-button-text' : 'create-category-form-button-text' }}"
