...
<div class="d-flex flex-column flex-grow-1 text-start" style="width: 50rem; min-width: 50rem; !important;">
    <div class="d-flex gap-3 justify-content-between">
        <section id="method-payment-section" class="table-container w-50 d-flex flex-column rounded-3 shadow-sm overflow-hidden p-2 pb-3">
            ...
            <div class="d-flex flex-column flex-grow-1 align-items-start justify-content-between gap-2 border-top pt-2 mt-2">
                {{-- Amount To Pay --}}
                ...
                {{-- Reference Number --}}
                <x-form.input :id="'reference_number'" :type="'numeric'" :class="'d-none border-secondary w-100'" :placeholder="'Ej: 612314431345'" :iconLeft="'bi bi-credit-card-2-back'" :textIconRight="true" :required="false">
                    Referencia de Pago:
                    <x-slot:iconRight>
        ...
        <form id="payment-details-form" class="table-container w-50 d-flex flex-column rounded-3 shadow-sm overflow-hidden p-2 pb-3" style="margin-block-end: 0;">
            ...
            <div id="payment-details" class="d-flex flex-column flex-grow-1 gap-2">
                @php
                    ...
                    $payments = collect($examplePayments);
                @endphp
                ...
                @forelse($payments as $payment)
                    <div class="payment-item d-flex align-items-center justify-content-between text-start border border-1 border-secondary-subtle rounded-3 p-2" style="background-color: rgba(0, 0, 0, 0.05);" data-payment-type="{{ $payment['type'] }}">
                        ...
                        <div class="d-flex align-items-center justify-content-end gap-3">
                            ...
                            <x-form.button :type="'button'" :class="'remove-payment-btn btn-sm btn-outline-danger p-2'" data-bs-toggle="tooltip" data-bs-title="Eliminar este pago del resumen." style="font-size: 0.75rem;">
                ...
                @empty
                    <div id="no-payments-message" class="d-flex flex-column flex-grow-1 justify-content-center align-items-center py-3 text-center text-muted">
                        ...
                        <span class="form-label">No se han agregado pagos.<br> Agrega un pago para ver el resumen aquí.</span>
                    </div>
                @endforelse
            </div>
