...
<x-tabs.content navId="main-tab" :container="false">
    {{-- Attendance Section --}}
    <x-tabs.item :active="true" :container="true" :itemClass="'w-50'" id="nav-attendance" icon="bi bi-calendar-plus" title="Registrar Horas Trabajadas">
        <div class="js-tab-lazy-content" data-tab="attendance" data-url="{{ route('attendance.tabs', ['tab' => 'attendance']) }}">
            <x-alert type="info" message="Cargando contenido..." />
        </div>
    </x-tabs.item>

    {{-- History Section --}}
    <x-tabs.item :container="true" id="nav-history" icon="bi bi-clock-history" title="Historial de Asistencia">
        <div class="js-tab-lazy-content mt-3" data-tab="history" data-url="{{ route('attendance.tabs', ['tab' => 'history']) }}">
