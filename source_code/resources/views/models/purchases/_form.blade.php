                        ...
                        <tbody id="details-container">
                            ...
                            @else
                                <tr id="empty-details-row">
                                    <td colspan="7" class="text-center text-muted fst-italic">No hay productos
                                        agregados.</td>
                                </tr>
                            @endif
                        </tbody>
        ...
        <form id="quick-product-form" action="{{ route('purchases.quick-product') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="number" step="0.01" min="0" class="form-control"
                    id="quick-product-reference-cost" name="reference_cost" placeholder="Ej: 1500.00">
            ...
            <div class="mb-3">
                ...
                <input type="number" step="0.01" min="0" max="1" class="form-control"
                    id="quick-product-tax-percentage" name="tax_percentage" placeholder="Ej: 0.13">
            ...
            <div class="mb-3">
                ...
                <input type="number" step="0.01" min="0" max="1" class="form-control"
                    id="quick-product-margin-percentage" name="margin_percentage" placeholder="Ej: 0.35">
            ...
            <div class="mb-3">
                ...
                <input type="number" step="0.01" min="0" class="form-control"
                    id="quick-product-sale-price" name="sale_price" readonly>
    ...
    <div class="offcanvas-body">
        <form id="quick-supply-form" action="{{ route('supplies.store') }}" method="POST">
            ...
            <div class="d-flex justify-content-end gap-2">
                ...
                <button type="button" class="btn btn-danger" data-bs-dismiss="offcanvas">Cancelar</button>
                <button type="submit" class="btn btn-success" id="quick-supply-submit">
                    <span class="spinner-border spinner-border-sm d-none" role="status" aria-hidden="true"
